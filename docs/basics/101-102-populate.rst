...
Lets see how this shows up in the history of the dataset with :command:`git log`.
...
Lets :command:`datalad save` precisely this file by specifying its path after the commit message:
...
A :command:`datalad status` should now be empty, and our datasets history should look like this:
