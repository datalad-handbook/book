...
.. windowsworkarounds:: Your Git log may be more extensive

   The output of ``git log`` shown in the handbook and the output you will see in your own datasets may not always match -- many times you might see commits about a "git-annex adjusted branch" in your history.
