...
.. windowsworkarounds:: Windows-Users need to start here instead
   ...
   We're really sorry about that - as foreshadowed in section :ref:`install`, Windows comes with a range of file system issues.
   ...
   Other parts of the handbook that are influenced by this will be marked with a similar "Windows Workaround" note.
