...
.. runrecord:: _examples/DL-101-101-101
   ...
   :workdir: dl-101
   :cast: dataset_basics
   :caption: We will start by creating a dataset with a configuration template and a description
...
.. runrecord:: _examples/DL-101-101-102
   ...
   :workdir: dl-101
   :cast: dataset_basics
   :caption: Let's see what is inside of a newly created dataset
...
.. runrecord:: _examples/DL-101-101-103
   ...
   :cast: dataset_basics
   :caption: A dataset is version controlled. Let's take a look into the history, even if it is small atm
