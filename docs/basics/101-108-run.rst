...
The :command:`datalad run` command can help with this. Put simply, it records a command's impact on a dataset. Put
...
:command:`datalad run` that does not result in any changes in a dataset (no modification
