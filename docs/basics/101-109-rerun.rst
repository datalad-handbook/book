...
.. runrecord:: _examples/DL-101-108-109
   ...
   :lines: 1-30
   :caption: The script produced a simple list of podcast titles. let's take a look into our output file. What's cool is that is was created in a way that the code and output are linked:
