...
If you opt for the first, your administrator can install some versions of DataLad version via `EasyBuild <https://github.com/easybuilders>`, which is a tool for building software reprobucibly and is common on clusters that use a module system.
