...
.. glossary::
   ...
   sed
      A powerful, shell-based stream editor. It is used to perform basic text
      transformations on an input stream. Find out more
      `here <https://www.gnu.org/software/sed/manual/sed.html>`__.
