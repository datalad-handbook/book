...
be happy to hear that this is achieved by simply cloning datasets
as subdatasets.
This part of this principle will therefore be absolutely obvious to you
because you already know how to clone and nest datasets within datasets.
...
.. figure:: ../img/data_origin.svg
   ...
   Schematic illustration of two standalone data datasets cloned as subdatasets
...
that can be cloned and retrieved on demand, and is kept clean from
