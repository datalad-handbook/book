.. index:: ! YODA principles
   pair: data organization; with DataLad
   pair: project management; with DataLad
.. _2-001:
.. _yoda:
...
You can get a few non-DataLad related advice for structuring your directories in the
:find-out-more:`on best practices for analysis organization <fom-yodaproject>`.
