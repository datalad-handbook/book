...
Tuning datasets to your needs: Configurations [1]
-------------------------------------------------
...
.. [#f1] As an alternative to a ``git config`` command, you could also run configuration
         templates or procedures (later in this chapter) that apply predefined configurations or in some cases even
