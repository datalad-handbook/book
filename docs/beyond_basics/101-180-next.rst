...
The :command:`datalad tree` visualizes directory and dataset hierarchies.
It mimics the UNIX/MSDOS 'tree' utility to generate and display a directory tree, with DataLad-specific enhancements.
