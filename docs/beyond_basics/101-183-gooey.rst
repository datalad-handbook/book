...
The ideal way to stay up-to-date on gooey developments is its documentation at `docs.datalad.org/projects/gooey <http://docs.datalad.org/projects/gooey/en/latest/>`_.
