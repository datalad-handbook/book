...
.. runrecord:: _examples/DL-101-103-102
   ...
   :workdir: dl-101/DataLad-101
   :cast: dataset_basics
   :caption: At first the file is untracked. We can save \wo path because it is the only existing modification
...
.. runrecord:: _examples/DL-101-103-104
   ...
   :workdir: dl-101/DataLad-101
   :cast: dataset_basics
   :caption: Now let's start to modify this textfile by adding more notes to it:
