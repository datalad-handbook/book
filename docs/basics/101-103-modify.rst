...
.. windowsworkarounds:: Heredocs don't work under Windows

   Heredocs rely on Unix-type redirection and multi-line commands -- neither of which are supported on Windows.
   Instead of executing heredocs, please open up an editor and paste and save the text into it.
