...
At this point, the workflow misses a tweak that is necessary in fMRIprep to enable re-running computations  (the complete file is in :ref:`this Findoutmore <fom_enki>`.
...
.. findoutmore:: Fine-tuning: Enable re-running
   ...
   You can find the full script with rich comments in :ref:`this Findoutmore <fom_enki>`.
...
.. findoutmore:: See the complete bash script
   ...
   For technical reasons (rending or the handbook), we break it into several blocks of code::
...
You can find the submit file used in this analyses in :ref:`this Findoutmore <fom_condor>`.
