...
.. find-out-more:: Dissecting a Git config file further
   ...
   For example, it lists the repository version and git-annex
   UUID [#f4]_ (which you have seen in :command:`git annex whereis` commands, that display information about where the
