...
In the last three sections, we demonstrated how to create a proper ``datalad run``
...
* A ``datalad run`` command generates a ``run-record`` in the commit. This runrecord can be used
