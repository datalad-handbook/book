...
each acquisition subdirectory. It does not need to follow any particular
...
Next, add a specification about the additional data to the ``studyspec.json``
file of this acquisition. In principle, this specification is information on
*where* additional data lies, and *what* should be done with it. Prior to
seeing how it is done, let's take a look at some finished examples:
