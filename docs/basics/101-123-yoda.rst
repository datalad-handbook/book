...
you have all the necessary skills to comply to it.
...
``datalad run`` call in the history of the dataset. Thus, using
...
available `slides <https://github.com/myyoda/talk-principles>`_.
