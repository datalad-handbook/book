...
.. windowsworkarounds:: datalad diff will not provide meaningful information in most usecases
   ...
   On a technical level, this is correct given the underlying file handling on Windows, but it isn't useful for users at all.
