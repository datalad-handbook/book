...
The content of this script is shown below -- the ``cat`` command
will write it into the script. Make sure to see the
:windows-wit:`on an alternative <ww-heredoc-alt>`, and check
