...
However, the `datalad gooey <http://docs.datalad.org/projects/gooey>`_ extensions extends it with a graphical user interface.
...
The ideal way to stay up-to-date on gooey developments is its documentation at `docs.datalad.org/projects/gooey <http://docs.datalad.org/projects/gooey>`_.
