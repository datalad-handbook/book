.. index::
   pair: provenance tracking; with DataLad
.. _run3:
...
The online-handbook has a chapter on the metadata aggregation capabilities of DataLad,
...
See the :windows-wit:`on installing it <ww-install-imagemagick>`, if your system does not provide it.
